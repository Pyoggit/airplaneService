...
public class CountryRegisterManager {
	...
	// 여행국 정보 출력
	public void selectCountryManager() throws SQLException {
		printCountryList();
	}

	// 여행국 정보 입력
	public void insertCountryManager() throws SQLException {
		CountryDAO countryDAO = new CountryDAO();
	...
	// 여행국 정보 수정
	public void updateCountryManager() throws SQLException {
		CountryDAO countryDAO = new CountryDAO();
	...
	// 여행국 정보 삭제
	public void deleteCountryManager() throws SQLException {
		CountryDAO countryDAO = new CountryDAO();
	...
	// 여행 국가 정보 찾기
	public void findCountryManager() throws SQLException {
		CountryDAO countryDAO = new CountryDAO();
