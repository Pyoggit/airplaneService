...
public class PlaneRegisterManager {
	...
	// 여객기 데이터 출력 (SELECT)
	public void selectPlaneManager() throws SQLException {
		printPlaneList();
	}

	// 여객기 정보 생성
	public void insertPlaneManager() throws SQLException {
		PlaneDAO planeDAO = new PlaneDAO();
	...
	// 여객기 정보 수정
	public void updatePlaneManager() throws SQLException {
		PlaneDAO planeDAO = new PlaneDAO();
	...
	// 여객기 정보 삭제
	public void deletePlaneManager() throws SQLException {
		PlaneDAO planeDAO = new PlaneDAO();
	...
	// 여객기 정보 찾기
	public void findPlaneManager() throws SQLException {
		PlaneDAO planeDAO = new PlaneDAO();
